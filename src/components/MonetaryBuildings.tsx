        ...
        <div>
            {buildingArray.map((building, index) => {
                const getButtonColor = (buildingName) => {
                    if (buildingName === "Library" || buildingName === "CLAS" || buildingName === 'Buchanan Hall' || buildingName === 'Phelps Hall') {
                        return "lightblue";
                    } else if (buildingName === 'University Center(UCEN)' || buildingName === "Anacapa" || buildingName === "Arbor") {
                        return "lightgreen";
                    }
                };
                ...
                return (
                  <div key={index}>
                    ...
                    >Name: {building.name}
                    <p> </p>
                    Description: {building.description}</Button>
                  </div>
                );
            })}
        </div>
